...
const FRASES_BASE: readonly FraseUi[] = [
  ...
  { slug: 'tienda', texto: 'Aqui gastas tus estrellas. Elige lo que quieras para tu Fuzz.' },
  ...
  { slug: 'sin-estrellas', texto: 'Todavia no tienes estrellas suficientes. Juega otra actividad para ganar mas.' },
  { slug: 'pocion-lista', texto: 'Listo. La pocion hara efecto en tu proxima actividad.' },
  { slug: 'mundo-nuevo', texto: 'Se abrio un mundo nuevo. Ya puedes jugarlo.' },
